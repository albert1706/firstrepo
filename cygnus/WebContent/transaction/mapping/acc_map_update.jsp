    ...
    <s:fielderror theme="jquery" />
			<div class="panel panel-default">
				...
				<div class="panel-body">                                                                        
					<div class="row">  
						<div class="col-md-12">
							<s:textfield id="classCode" value="%{tm.classCode}" name="classCode" cssClass="form-control" maxlength="5" placeholder="Class Code" label="Kode Mapping" requiredLabel="true"></s:textfield>
							<s:textfield name="trxName" value="%{tm.trxName}"  cssClass="form-control" placeholder="Mapping Name" label="Nama Mapping" requiredLabel="true"></s:textfield>
    ...
    <div class="col-md-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="row">  
					<div class="col-md-6">
				    	<div class="panel panel-warning">
				            ...
				            <div class="panel-body">
 				            	<s:select id="debet" theme="simple" name="debet" multiple="true" list="listDebet" listKey="accNo" listValue="accName" cssClass="form-control" />
 				            </div>     
				    ...
				    <div class="col-md-6">
				    	<div class="panel panel-info">
				             ...
				             <div class="panel-body">
				             	 <s:select id="kredit" theme="simple" name="kredit" multiple="true" list="listCredit" listKey="accNo" listValue="accName" cssClass="form-control" />
				             </div>                            
				             <div class="panel-footer">
               ...
               <div class="panel-footer">
               	<s:token />
               	<s:url var="urlgrid" action="TransactionMappingMainAction" namespace="cygnus/transaction/trx"/>
