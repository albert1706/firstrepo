...
<jnds:breadcrumb list="Home > User Management > User Group > Modify" />
<jnds:pagetitle value="User Group" />

<s:form id="frmUpdate" action="id/co/nds/webapp/usergroup/DoUpdateAct.action" target="content" theme="simple" cssClass="form-horizontal">
<input type="hidden" id="groupId" name="groupId" value="<s:property value="Ug.groupId" />" />
<input type="hidden" id="oldGroupName" name="oldGroupName" value="<s:property value="Ug.groupName" />" />
<!-- START MAIN CONTENT -->
<div class="row">
    <div class="col-md-12">
    	<s:actionerror theme="jquery" />
			<div class="panel panel-default">
            	<div class="panel-heading">
                	<h3 class="panel-title"><strong>Modify Group</strong></h3>
				</div>
					...
					<div class="row">  
						<div class="col-md-6">
                             <div class="form-group">
                                 ...
                                 <div class="col-md-9">                                            
                                     <div class="input-group">
                                         ...
                                         <input id="groupName" name="groupName" type="text" class="form-control" placeholder="Nama Group" value='<s:property value="Ug.groupName" />' />
                                     </div>                                            
                             ...
                             <div class="form-group">
                                 ...
                                 <div class="col-md-9">     
                                 	 <textarea id="groupDesc" name="groupDesc" rows="5" class="form-control" placeholder="Keterangan" ><s:property value="Ug.groupDesc" /></textarea>                                       
                                     <span class="help-block"></span>
                                 </div>
                             </div>
						</div>   
                ...
                <div class="panel-footer">
					...
					<s:url var="urldelete" action="DoDeleteAct" namespace="/id/co/nds/webapp/usergroup"/>
				<sj:a id="btnDelete" href="%{urldelete}" cssClass="btn btn-danger" targets="content" indicator="indicator" button="false">Delete</sj:a>
            	</div>
        	</div>
    </div>
</div>
...
(function() {
	...
	YAHOO.util.Event.on("btnDelete", "mousedown", function(e) {
		var result = confirm('Arey you sure want to delete this form?');
		if (result == true) {
			document.forms['frmUpdate'].action='id/co/nds/webapp/usergroup/DoDeleteAct.action';
			document.getElementById('btnSubmit').click();
		}
	});
