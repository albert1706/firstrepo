		...
		<form id="frm" name="frm" class="form-horizontal">
			<div class="panel panel-default">
				...
				<div class="panel-body">      
					<s:textfield name="accLv3Name" cssClass="form-control" placeholder="Nama Akun" label="Nama Akun" tooltip="fa fa-pencil"></s:textfield>                                                                  
				</div>
                <div class="panel-footer">
                	...
                	<s:url var="urlgrid" action="PrepareCreateAct" namespace="cygnus/acc/acc_level3"  />
        ...
        <!-- START SEARCH TABLE -->
        	<div class="panel panel-default">
        		<div class="panel-body panel-body-table">
                	<s:url var="remoteurl" action="AccountLevel3SearchAction" namespace="cygnus/acc/acc_level3"  />
					<sjg:grid
						id="gridtable"
						caption="Account Level 3"
						dataType="json"
						href="%{remoteurl}"
						pager="true"
						toppager="true"
						...
						groupField="['accLv1Name', 'accLv2Name']"
						groupColumnShow="[true, true]"
						groupSummary="[true, true]"
						groupCollapse="false"
						>
						<sjg:gridColumn cssClass="thePointer" hidden="true" name="id" index="id" title="ID" width="100" sortable="true"/>
						<sjg:gridColumn cssClass="thePointer" name="accLv3Id" index="acc_lv3_id" title="Akun L3 ID" width="50" sortable="true"/>	
...
<script type="text/javascript">
  ...
  $("#gridtable").subscribe('getDetail', function(event, data) {
	    ...
	    var actUrl= "cygnus/acc/acc_level3/PrepareUpdateAct.action?id="+selectedId;
